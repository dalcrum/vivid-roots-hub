-- Fix encoding issues in project data
-- Delete old data and re-insert with clean ASCII-safe text

DELETE FROM public.update_photos;
DELETE FROM public.project_updates;
DELETE FROM public.projects;

-- Re-insert projects with safe characters
...
(
  ...
  'Aldea Nueva Esperanza - Reparacion de Techo Escolar',
  'Education',
  'in_progress',
...
(
  ...
  'San Marcos La Laguna is a small lakeside town on the shores of Lake Atitlan, home to approximately 3,000 residents, most of whom are Tz''utujil Maya. The town is accessible primarily by boat or a single winding road. Before the health station, residents needing medical care had to travel by lancha (boat) to Panajachel - a 30-minute ride across the lake that costs more than most families earn in a day.',
  '2025-06-01',
  '2025-09-15'
);

-- Re-insert project updates
...
(
  ...
  'a1b2c3d4-0001-4000-8000-000000000001',
  'La comunidad estuvo increiblemente involucrada. Don Pedro, el lider comunitario, organizo turnos de trabajo voluntario. Los padres de familia ayudaron a cavar las zanjas para la tuberia. Fue hermoso ver como toda la comunidad se unio para este proyecto.',
  ...
  'Maria Elena',
  8,
  'Ahora puedo tomar agua en la escuela sin que me duela el estomago.',
  'Now I can drink water at school without my stomach hurting.',
  'Maria Elena walks 2.3 kilometers each morning along a dirt path that winds through coffee fields to reach Escuela Primaria El Mirador. For the past three years, she and her 88 classmates shared a single water source - an untreated well behind the school kitchen that had been flagged by local health workers for dangerous bacteria levels. The children often complained of stomach pain. Some missed days of school. Maria Elena''s mother, Dona Carmen, would send her with a small bottle of water from home, but it was never enough for a full day under the Guatemalan sun.',
  'Today, Maria Elena runs straight to the new water station during recess. The filtration system, installed by community volunteers alongside the Vivid Roots team, serves all 89 students and 12 staff members with clean, safe drinking water. Stomach complaints have dropped dramatically. Attendance is up. And Maria Elena no longer needs to carry that small bottle from home - though her mother still sometimes tucks one in her backpack, just out of habit.',
  NULL,
  'published'
),
(
  ...
  'a1b2c3d4-0002-4000-8000-000000000002',
  'El progreso va bien! Los materiales llegaron la semana pasada. La comunidad ya empezo con la mano de obra. El director de la escuela esta muy emocionado.',
...
(
  ...
  'a1b2c3d4-0003-4000-8000-000000000003',
  'El puesto de salud esta funcionando completamente. La enfermera viene tres veces por semana. Las familias ya no tienen que cruzar el lago para consultas basicas.',
  ...
  'Dona Lucia has lived in San Marcos La Laguna her entire life. As a traditional midwife, she has delivered over 200 babies in the community. But when medical emergencies arose - a child with a high fever, an elder with chest pain - the only option was the dangerous nighttime boat ride across Lake Atitlan to Panajachel. More than once, she watched families delay seeking care because they feared the crossing.',
  'The new health station, built with local materials and staffed by a rotating nurse from the regional health department, now provides basic medical care, vaccinations, and emergency stabilization. Dona Lucia volunteers at the station three mornings a week, bridging traditional and modern medicine for her community.',
  NULL,
  'published'
);
...
('b1b2c3d4-0003-4000-8000-000000000003', 'https://images.unsplash.com/photo-1669176877597-da92c8a5bbfa?w=600&q=80', 'Dona Lucia at the station', false);
